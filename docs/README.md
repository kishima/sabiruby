...
One file per piece of work, `YYYY-MM-DD-<slug>.md`, written while the work happened. The three
of 2026-09-15 are the records of `host-bridge-plan.md`'s stages 2, 2b, 2c, 4 and 5.
